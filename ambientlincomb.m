...
% It is not always the case in manopt (see, e.g. fixed-rank manifold),
...
% fullMat1 = problem.M.triplet2matrix(d1); % From SVD to full matrix
% fullMat2 = problem.M.triplet2matrix(d2); % From SVD to full matrix
% matRes = matrixlincomb(x,a1,fullMat1,a2,fullMat2);
    
% res = problem.M.matrix2triplet(matRes); % From full matrix to SVD
% The last line may not be needed if f can take as input matrices
